...
<body>
	<div>
		<form action="http://canvas.nullcool.com/ftpuploadtw.php" method="post" enctype="multipart/form-data"><b>Escribe el texto a compartir:</b><br> 
